# Custom launch file for WAM-V with LiDAR and IMU sensor
...
def generate_launch_description():
    ...
    # Node parameters, including those from the YAML configuration file (WAM-V LiDAR config)
    laser_mapping_params = [
        PathJoinSubstitution([
            FindPackageShare('point_lio'),
            'config', 'wamv_lidar.yaml'
        ]),
        {
