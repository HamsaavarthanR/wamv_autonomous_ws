...
def generate_launch_description():
    ...
    laser_mapping_params = [
        ...
        ]),
        {
            ...
            'check_satu': True,
            'init_map_size': 20, # 10
            'point_filter_num': 3,  # Options: 1, 3, Originally: 1
            'space_down_sample': True,
            'filter_size_surf': 0.3,  # Options: 0.5, 0.3, 0.2, 0.15, 0.1, Originally: 0.1
            'filter_size_map': 0.5,  # Options: 0.5, 0.3, 0.15, 0.1, Originally: 0.1
            'cube_side_length': 200.0,  # Option: 1000 meters
