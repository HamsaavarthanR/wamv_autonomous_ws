...
// Wam-V LiDAR handler
void Preprocess::wamv_lidar_handler(const sensor_msgs::msg::PointCloud2::SharedPtr &msg)
{
    //DEBUGGING
    cout << "Wamv handler called!" << endl;
    pl_surf.clear();
    pl_corn.clear();
    pl_full.clear();

    pcl::PointCloud<wamv_lidar_ros::Point> pl_orig;
